...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: PersonQueue was adding people to the front of the queue
    ...
    // Defect(s) Found: None, was likely fixed when testing TestTakingTurnsQueue_FiniteRepetition
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: TakingTurnsQueue did not provide logic for placing people with 0 or less turns back in the queue
    ...
    // Defect(s) Found: None, likely fixed when testing TestTakingTurnsQueue_ForeverZero
    ...
    // Defect(s) Found: None, possibly fixed when testing the previous tests
